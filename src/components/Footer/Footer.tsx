  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col ml-5 pt-5">
        ...
        <div className=" grid  grid-cols-2 sm:grid-cols-4 items-center justify-between mt-16  mb-16">
          ...
          <div className="flex sm:items-center sm:justify-center">
            <div className="flex flex-col gap-5">
              ...
              <span className="text-[#FAFAFA] font-medium text-sm cursor-pointer items-center flex">
                Joinus
              ...
              <span className="text-[#FAFAFA] font-medium text-sm cursor-pointer ">Legal</span>
            </div>
          </div>
        ...
        <div>
          <p className="text-[#FAFAFA] font-medium text-sm cursor-pointer mb-8">
